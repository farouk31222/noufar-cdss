...
const normalizePatientEntry = (entry = {}) => ({
  ...
  consultationReason: entry.consultationReason || entry.inputData?.consultationReason || "Not specified",
...
const populatePatientForm = (patient) => {
  ...
  const values = {
    ...patient.inputData,
    name: patient.inputData?.name || patient.patientName,
    age: patient.inputData?.age ?? patient.age,
    sex: patient.inputData?.sex || patient.sex || "Not specified",
    consultationReason: patient.inputData?.consultationReason || patient.consultationReason,
    duration: patient.inputData?.duration ?? patient.duration,
    source: patient.inputData?.source || patient.source || "Manual",
  };
    ...
    <label class="toggle-switch-field">
      ...
      <span class="toggle-switch-control is-readonly tri-toggle-readonly">
        <span class="tri-toggle tri-toggle-readonly-group" role="group" aria-label="${escapePatientHtml(label)}">
          <button type="button" class="tri-toggle-btn ${state === "Yes" ? "is-active" : ""}" disabled>Yes</button>
          <button type="button" class="tri-toggle-btn ${state === "Not measured" ? "is-active" : ""}" disabled>Not measured</button>
          <button type="button" class="tri-toggle-btn ${state === "No" ? "is-active" : ""}" disabled>No</button>
        </span>
      </span>
    </label>
  `;
